...
<div class="container">
  <h1 class="wow fadeInRight">Artist Edit</h1>
  ...
  @endif
      <div class="page-banner home-banner h-50 mt-4">
        <div class="row flex-wrap-reverse">
          ...
          <form class="col-md-11 m-4 mt-5 mb-5 wow fadeInUp" action="{{ url('artist/'.$artist->id) }}" method="post">
              @method('put')
              @csrf
              <div class="form-row">
                  <div class="form-group col-md-4">
                      <label for="">Name</label>
                      <input class="form-control" value="{{ old('name', $artist-> name) }}" type="text" name="name" placeholder="artist's name" minlength="1" maxlength="80" required />
                  </div>
              </div>
              <!--<div class="form-row">-->
