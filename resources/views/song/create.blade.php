...
<div class="container">
  <h1 class="wow fadeInRight">Add New Song</h1>
  ...
  @endif
      <div class="page-banner home-banner h-50 mt-4">
        <div class="row flex-wrap-reverse">
          ...
          <form class="col-md-11 m-4 mt-5 mb-5 wow fadeInUp" action="{{ url('song') }}" method="post">
              @csrf
              <div class="form-row">
                  <div class="form-group col-md-4">
                      <label for="">Name</label>
                      <input class="form-control" value="{{ old('name') }}" type="text" name="name" placeholder="song's name" minlength="1" maxlength="80" required />
                  </div>
                  
                  <div class="form-group col-md-4">
                      <label for="">Duration</label>
                      <input class="form-control" value="{{ old('duration') ?? '00:00:00' }}" type="time" name="duration" placeholder="song's duration" step="1" required />
                  </div>
              ...
              <div class="form-row">
                <div class="col-md-4">
                  <input type="submit" name="btCreate"  type="submit" value="Create Song" class="btn btn-primary">
                </div>
              </div>
