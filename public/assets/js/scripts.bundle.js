...
$(function() {
    AppConfig = {
        ...
        ajaxLoading: function(t) {
            window.history.pushState("", "", t), $.ajax({
                url: t,
                context: document.body
            }).done(function(s) {
                var e, i, a = $("<div>" + s + "</div>");
                e = a, $("head title").html(e.find("title").html()),
                    function(t) {
                        var s = $(".banner"),
                            e = s.attr("class");
                    ...
                    function(t) {
                        $("#appRoute").html(t.find("#appRoute").html()), $("#wrapper").animate({
                            scrollTop: 0
                        }, "fast"), Analytics.init(), AppConfig.reInitFunction()
        ...
        slickCarousel: function(t, s, e, i, a) {
            $(t).slick({
                ...
                slidesToScroll: 1,
                speed: 1e3,
                prevArrow: '<button class="btn-prev btn btn-pill btn-air btn-default btn-icon-only"><ion-icon name="chevron-back"></ion-icon></button>',
                nextArrow: '<button class="btn-next btn btn-pill btn-air btn-default btn-icon-only"><ion-icon name="chevron-forward"></ion-icon></button>',
                autoplay: !0,
                responsive: [{
                    breakpoint: 1440,
                    settings: {
        ...
        addFavorite: function() {
            var t = $(".favorite"),
                s = '<li><span class="badge badge-pill badge-danger"><ion-icon name="heart" class="heart"></ion-icon></span></li>';
            t.on("click", function(t) {
                t.stopPropagation();
                var e = $(this).closest(".custom-card--info"),
                    i = e.find(".custom-card--labels");
                if (i.length && !e.find(".custom-card--labels li .heart").length) i.append(s);
                else {
                    e.prepend('<ul class="custom-card--labels d-flex"><li><span class="badge badge-pill badge-danger"><ion-icon name="heart" class="heart"></ion-icon></span></li></ul>')
                }
            })
        }
    };
...
$(function() {
    ...
    function(t, s, e, i) {
        ...
        a.Defaults = {
            ...
            settingIcon: '<ion-icon name="settings"></ion-icon>',
            itemElement: "div",
